...
module Zoogigant
    ...
    class HomePage
		...
		div(:category_menu, :xpath => "//div[@id=\"megadropdown\"]")
		
		
		
		div(:product_links, :xpath=> "//div[@id=\"product_listing\"]")
		...
		def get_product_keywords_to_exclude
			...
			return ["Canvas", "Boot", "Digital", "Mens", "Shoes", "Flop", "Trainer"]
		...
		def get_static_test_cat_url
			...
			return "http://www.zoogigant.de/Vogel/Wintervogelfutter-1385/Meisenringe-1391/"

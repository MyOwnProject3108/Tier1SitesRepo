...
module Dmaxde
    ...
    class HomePage
		...
		text_field(:search_field, :id => "searchfield")
        
		
		link(:login_link, :title => "Mein Konto")
		
        # site elements
		
		 
		
		div(:category_menu, :id => "mainNavigation")
		
		
		
		div(:product_links, :id => "listing-3col")
		...
		def get_categories_to_exclude
			...
			return ["Home", "GeschenkefinderHie", "Motor", "zubehoer", "wuerze"]

...
module Demostoredev
    ...
    class HomePage
		...
		URL = "http://showcase-dev.peerius.com/index.php"
		direct_url URL
		...
		link(:login_link, :href=> "http://showcase-dev.peerius.com/index.php/customer/account/login/")
		...
		def get_categories_to_exclude
			...
			return ["Home", "title=>Electricals", "title=>Entertainment", "url=>bathroom", "Health & Beauty"]
		...
		def get_static_test_prod_url
			...
			return "http://showcase-dev.peerius.com/index.php/10455858.html"

...
Scenario Outline: Selected SMART-recs attributes can be retrieved using SMART-API-CURRENTLY THIS SCENARIO FAILS AS LIVEDEMOSHOP DOESN'T SERVE ANY RECS
    Given I am using SMART-API to access livedemoshop
    ...
    Scenario Outline: SMART-recs attributes are only sent when requested using SMART-API-CURRENTLY THIS SCENARIO FAILS AS LIVEDEMOSHOP DOESN'T SERVE ANY RECS
        Given I am using SMART-API to access livedemoshop

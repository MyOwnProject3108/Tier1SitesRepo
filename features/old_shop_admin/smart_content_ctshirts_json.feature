@old_shop_admin
Feature: Old Shop Admin Smart Content CT Shirts

#
# Verifying the smartcontent for ctshirts
#
 
Scenario:Users should be able to see smartcontent for ctshirts through JSON
 ...
 And I enter the creative name as "AutoLS1CreativeJSON"
 ...
 And I enter content name as "AutoCTShirtsSmartContentJSON" on the smartcontent location page
 And I select content location as Home_JSON_IP
 Then I click on the Add content button on the smartcontent location page
 And I select creative image as "AutoLS1CreativeJSON" on the smartcontent location page

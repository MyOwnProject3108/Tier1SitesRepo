...
@topshopus
@smartapi
Feature: Topshop USA SMART-API tracking

Scenario Outline: Topshop USA Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access topshopus
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access topshopus
    And I am using client token 

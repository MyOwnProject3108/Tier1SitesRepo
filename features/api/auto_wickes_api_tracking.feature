...
@wickes
@smartapi
Feature: Wickes SMART-API tracking

Scenario Outline: Wickes Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access wickes
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access wickes
    And I am using client token 

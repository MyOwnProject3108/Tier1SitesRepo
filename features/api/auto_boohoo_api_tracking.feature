...
@boohoo
@smartapi
Feature: boohoo SMART-API tracking

Scenario Outline: boohoo Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access boohoo
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access boohoo
    And I am using client token 

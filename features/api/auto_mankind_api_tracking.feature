...
@mankind
@smartapi
Feature: mankind SMART-API tracking

Scenario Outline: mankind Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access mankind
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access mankind
    And I am using client token 

...
@thewhitecompany
@smartapi
Feature: thewhitecompany SMART-API tracking

Scenario Outline: thewhitecompany Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access thewhitecompany
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access thewhitecompany
    And I am using client token 

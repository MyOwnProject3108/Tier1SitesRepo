...
@cottontraders
@smartapi
Feature: Cotton Traders SMART-API tracking

Scenario Outline: Cotton Traders Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access cottontraders
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access cottontraders
    And I am using client token 

...
@notonthehighstreet
@smartapi
Feature: NotontheHighStreet SMART-API tracking

Scenario Outline: NotontheHighStreet Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access notonthehighstreet
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access notonthehighstreet
    And I am using client token 

...
@thehut
@smartapi
Feature: The Hut SMART-API tracking

Scenario Outline: The Hut Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access thehut
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access thehut
    And I am using client token 

@redletterdays
@smartapi
Feature: Red Letter Days SMART-API tracking

Scenario Outline: Red Letter Days Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access redletterdays

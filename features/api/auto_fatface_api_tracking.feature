...
@fatface
@smartapi
Feature: fatface SMART-API tracking

Scenario Outline: fatface Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access fatface
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access fatface
    And I am using client token 

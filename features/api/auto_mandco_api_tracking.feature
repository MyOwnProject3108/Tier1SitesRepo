...
@mandco
@smartapi
Feature: Mandco SMART-API tracking

Scenario Outline: Mandco Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access mandco
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access mandco
    And I am using client token 

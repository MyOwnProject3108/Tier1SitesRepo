...
@lookfantastic
@smartapi
Feature: Look Fantastic SMART-API tracking

Scenario Outline: Look Fantastic Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access lookfantastic
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access lookfantastic
    And I am using client token 

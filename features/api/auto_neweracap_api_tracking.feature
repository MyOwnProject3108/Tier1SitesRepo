...
@neweracap
@smartapi
Feature: NewEraCap SMART-API tracking

Scenario Outline: NewEraCap Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access neweracap
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access neweracap
    And I am using client token 

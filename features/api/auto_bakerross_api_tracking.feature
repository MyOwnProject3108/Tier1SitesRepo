...
@bakerross
@smartapi
Feature: Baker Ross SMART-API tracking

Scenario Outline: Baker Ross Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access bakerross
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access bakerross
    And I am using client token 

...
@topmanus
@smartapi
Feature: Topman USA SMART-API tracking

Scenario Outline: Topman USA Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access topmanus
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access topmanus
    And I am using client token 

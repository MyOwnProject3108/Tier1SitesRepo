...
@republic
@smartapi
Feature: CT Shirts SMART-API tracking

Scenario Outline: CT Shirts Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access republic
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access republic
    And I am using client token 

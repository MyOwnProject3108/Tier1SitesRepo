...
@zavvi
@smartapi
Feature: Zavvi SMART-API tracking

Scenario Outline: Zavvi Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access zavvi
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access zavvi
    And I am using client token 

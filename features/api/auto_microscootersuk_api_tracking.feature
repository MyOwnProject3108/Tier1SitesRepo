@microscootersuk
@smartapi
Feature: Microscooters UK SMART-API tracking

Scenario Outline: Microscooters UK Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access microscootersuk

...
@Mandmdirect
@smartapi
Feature: MandMDirect SMART-API tracking

Scenario Outline: MandMDirect Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access Mandmdirect
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access Mandmdirect
    And I am using client token 

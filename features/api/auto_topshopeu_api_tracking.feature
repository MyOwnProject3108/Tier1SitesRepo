...
@topshopeu
@smartapi
Feature: Topshop EU SMART-API tracking

Scenario Outline: Topshop EU Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access topshopeu
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access topshopeu
    And I am using client token 

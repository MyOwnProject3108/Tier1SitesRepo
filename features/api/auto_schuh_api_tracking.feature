...
@schuh
@smartapi
Feature: Schuh SMART-API tracking

Scenario Outline: Schuh Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access schuh
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access schuh
    And I am using client token 

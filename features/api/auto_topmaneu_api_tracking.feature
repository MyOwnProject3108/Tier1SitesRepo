...
@topmaneu
@smartapi
Feature: Topman EU SMART-API tracking

Scenario Outline: Topman EU Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access topmaneu
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access topmaneu
    And I am using client token 

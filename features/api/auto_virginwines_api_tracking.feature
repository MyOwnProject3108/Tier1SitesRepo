...
@virginwines
@smartapi
Feature: Virgin wines SMART-API tracking

Scenario Outline: Virgin wines Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access virginwines
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access virginwines
    And I am using client token 

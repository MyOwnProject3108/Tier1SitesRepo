...
@beautyexpert
@smartapi
Feature: Beautyexpert SMART-API tracking

Scenario Outline: Beautyexpert Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access beautyexpert
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access beautyexpert
    And I am using client token 

...
@frenchconnection
@smartapi
Feature: frenchconnection SMART-API tracking

Scenario Outline: frenchconnection Homepage is tracked using SMART-API
    Given I am using SMART-API <version> to access frenchconnection
...
Scenario: Order page is tracked using SMART-API v1.1
    Given I am using SMART-API to access frenchconnection
    And I am using client token 
